...
public final class SsaBuilderTest {
    ...
    private static void loop() {
        ...
        Assert.assertEquals("; SSA form of target 8086, entry main\n"
                        ...
                        + "    i#3 = phi(block0: i#1, block1: i#6)\n"
                        + "    flags#4, carry#5 = cmp i#3, n#2\n"
                        + "    jc ..@lbl0\n"
                        + "\n"
                        + "block3 <- block2:\n"
                        + "    ret\n",
    ...
    private static void theDirectionFlagIsMerged() {
        Assert.assertEquals("; SSA form of target 8086, entry main\n"
                        ...
                        + "    direction#8 = phi(block1: direction#6, block2: direction#7)\n"
